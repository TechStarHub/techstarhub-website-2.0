...
import { useAnimate, useInView, motion, animate } from 'framer-motion';
  ...
  return (
    <div ref={cardScope} className="w-full flex min-h-screen relative ">
      ...
      <div className="flex flex-col gap-[4rem] justify-center items-center my-20">
        <div
          ref={card1}
          className="bg-[#1F4068] text-slate-300 p-6 rounded-lg w-3/4 md:w-1/2 md:relative md:-left-20 "
        >
        ...
        <div
          ref={card2}
          className="bg-[#221F3B] text-slate-300 p-6 rounded-lg w-3/4 md:w-1/2 md:relative md:left-20"
        >
